...
def upload_to_vk(video_path, description="", title=""):
    ...
    try:
        ...
        # Prepare message
        message = description if description else "✨ Sydney Sweeney Daily!\n\n#sydneysweeney #hollywood #celebrity #fashion"
        ...
        video = upload.video(
            ...
            name=title or 'Sydney Sweeney Daily Video',
...
def main():
    ...
    description = sys.argv[2] if len(sys.argv) > 2 else "Daily Sydney Sweeney Moment! ✨"
    title = sys.argv[3] if len(sys.argv) > 3 else "Sydney Sweeney Daily"
